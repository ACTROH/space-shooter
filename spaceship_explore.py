...
def spawn_enemy():
    for _ in range(5):
        enemies.add(Enemy('enemy.png', random.randint(80, win_width - 80), random.randint(-500, -80), 80, 80, 2))

enemies = pygame.sprite.Group()
bullets = pygame.sprite.Group()
bonuses = pygame.sprite.Group()

player = Player('spaceship.png', win_width/2, win_height - 80, 80, 80, 0.4)
